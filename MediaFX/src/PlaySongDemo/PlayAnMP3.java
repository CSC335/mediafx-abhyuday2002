 ...
 * Purpose: Pushed some changes before committing this file to Github classroom
 */
...
public class PlayAnMP3 extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		// Changed song name before pushing commit
		String path = "songfiles/BearDownArizona.mp3";

		pane.setCenter(new Label(path));
		playASong(path);
		// Put the pane in a sized Scene and show the GUI
		// I changed the scene dimensions to 300 x 125

		Scene scene = new Scene(pane, 300, 125); // 255 pixels wide, 85 pixels tall
